...
\textbf{`dotnet run ../examples/example-1.arp example-1.wav'}
...
\textbf{`dotnet run ../examples/example-2.arp example-2.wav'}
...
\textbf{`dotnet run ../examples/example-3.arp example-3.wav'}
